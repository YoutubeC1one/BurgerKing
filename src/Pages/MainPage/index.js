  ...
  const images = [
    {
      key: 1,
      image:
        "https://d1cua0vf0mkpiy.cloudfront.net/images/web/banner/3f2e012b-20c8-4548-b0cc-60157c10503f.png",
    },
    {
      key: 2,
      image:
        "https://d1cua0vf0mkpiy.cloudfront.net/images/web/banner/5e65f5ca-3f24-4203-ad15-be281675562c.png",
    },
    {
      key: 3,
      image:
        "https://d1cua0vf0mkpiy.cloudfront.net/images/web/banner/00264d7b-12fd-4d3b-a634-9b83b7afe2c1.png",
    },
    {
      key: 4,
      image:
        "https://d1cua0vf0mkpiy.cloudfront.net/images/web/banner/502f4da9-2fce-4a9e-aca0-c221bdd2200d.jpg",
    },
    {
      key: 5,
      image:
        "https://d1cua0vf0mkpiy.cloudfront.net/images/web/banner/b80086f2-3528-438b-bb89-8c8a93e3abac.png",
    },
  ];
  const findShop = [
    {
    ...
    <>
      <S.Container>
        ...
        <iframe
          width="1440"
          height="605"
          src="https://www.youtube.com/embed/4CO98aFxRbA"
          ...
          <S.SnsList>
            ...
            >
              <S.SnsItem>
                <img src={snsYoutube} />
                <S.SnsItem_>
                  <S.RoundedFont>YOUTUBE</S.RoundedFont>
                  <S.SnsItemButton>
                    <img src={snsY_} />
            ...
            <S.StyledLink
              href="https://www.facebook.com/burgerkingkorea"
              target="_blank"
            >
              <S.SnsItem>
                <img src={snsF} />
                <S.SnsItem_>
                  <S.RoundedFont>FACEBOOK</S.RoundedFont>
                  <S.SnsItemButton>
                    <img src={snsI_} />
                    <div style={{ marginLeft: "5px" }}>
                      <S.KoreanFont
            ...
            >
              <S.SnsItem>
                <img src={snsI} />
                <S.SnsItem_>
                  <S.RoundedFont>INSTAGRAM</S.RoundedFont>
                  <S.SnsItemButton>
                    <img src={snsF_} />
                    <div style={{ marginLeft: "5px" }}>
                      <S.KoreanFont
        ...
        <S.MainDeliveryGuide>
          ...
          <img
            src={howToUseDelivery}
            style={{ backgroundColor: "#b18872" }}
          ></img>
        </S.MainDeliveryGuide>
        <S.MainSearchShop>
          ...
          <S.MainSearchButton>
            <S.KoreanFont style={{ fontSize: "27px" }}>매장찾기</S.KoreanFont>
          </S.MainSearchButton>
          <S.MainSearchList>
        ...
        <S.MainBurgerKingPhone>
          ...
          >
            <div>
              ...
              >
                딜리버리 전화주문 안내 10:00-22:00 / 연중무휴 (매장별로 상이할
                수 있습니다.)
              </S.KoreanFont>
            </div>
            <img
